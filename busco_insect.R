...
# Output
my_output <- paste("refined_graph/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"

# Colors
my_colors <- c("yellowgreen", "#1592F7", "#F0E332", "#F04442")
# Bar height ratio
my_bar_height <- 0.75

# Legend
my_title <- "C. partellus BUSCO Assessment Results"
...
my_species <- c('SPAdes', 'SPAdes', 'SPAdes', 'SPAdes', 'Trinity', 'Trinity', 'Trinity', 'Trinity', 'evigene_best_tr', 'evigene_best_tr', 'evigene_best_tr', 'evigene_best_tr', 'SOAPdenovo-Trans', 'SOAPdenovo-Trans', 'SOAPdenovo-Trans', 'SOAPdenovo-Trans', 'Velvet_Oases', 'Velvet_Oases', 'Velvet_Oases', 'Velvet_Oases')
...
my_percentage <- c(69.4, 0.3, 21.8, 8.5, 49.6, 44.3, 4.3, 1.8, 92.0, 3.2, 3.3, 1.5, 87.2, 6.3, 4.8, 1.7, 55.1, 38.7, 4.4, 1.8)
my_values <- c(703, 3, 221, 86, 502, 449, 44, 18, 932, 32, 33, 16, 883, 64, 49, 17, 558, 392, 45, 18)
